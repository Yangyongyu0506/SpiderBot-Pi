...
set(_exported_libraries "hardware_interface__rosidl_generator_c;hardware_interface__rosidl_typesupport_c;hardware_interface__rosidl_typesupport_cpp")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'hardware_interface' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND hardware_interface_LIBRARIES ${_cfg} "${_lib}")
